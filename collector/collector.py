...
# Push cadence in seconds. Default 2.0 sends ~43k/day, leaving headroom
# under Cloudflare's free tier (100k/day) for browser polling. Bump to
# 1.0 only on the paid Workers tier.
